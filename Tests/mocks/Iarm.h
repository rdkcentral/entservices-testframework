...
public:
    ...
    virtual IARM_Result_t IARM_Bus_Disconnect() = 0;
    virtual IARM_Result_t IARM_Bus_Term() = 0;
...
public:
    ...
    static IARM_Result_t IARM_Bus_Disconnect();
    static IARM_Result_t IARM_Bus_Term();
...
extern IARM_Result_t (*IARM_Bus_Disconnect)();
extern IARM_Result_t (*IARM_Bus_Term)();
