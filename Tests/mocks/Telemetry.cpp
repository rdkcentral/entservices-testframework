...
void TelemetryApi::t2_uninit(void)
{
    EXPECT_NE(impl, nullptr);
    impl->t2_uninit();
}

T2ERROR TelemetryApi::t2_event_s(const char* marker, const char* value)
{
    EXPECT_NE(impl, nullptr);
    return impl->t2_event_s(marker, value);
}

T2ERROR TelemetryApi::t2_event_d(const char* marker, int value)
{
    EXPECT_NE(impl, nullptr);
