...
public:
        ...
        : IarmBusImpl()
    {
        ...
        ON_CALL(*this, IARM_Bus_Disconnect())
            .WillByDefault(::testing::Invoke(
                []() {
                    TEST_LOG("Mock IARM_Bus_Disconnect called");
                    return IARM_RESULT_SUCCESS;
                }));
        ON_CALL(*this, IARM_Bus_Term())
            .WillByDefault(::testing::Invoke(
                []() {
                    TEST_LOG("Mock IARM_Bus_Term called");
                    return IARM_RESULT_SUCCESS;
                }));
    ...
    MOCK_METHOD(IARM_Result_t, IARM_Bus_Disconnect, (), (override));
    MOCK_METHOD(IARM_Result_t, IARM_Bus_Term, (), (override));
