...
class EssRMgrImpl {
public:
    virtual ~EssRMgrImpl() = default;

    virtual bool EssRMgrInit() = 0;
    virtual void EssRMgrTerm() = 0;
    virtual EssRMgr* EssRMgrCreate() = 0;
    virtual void EssRMgrDestroy(EssRMgr* rm) = 0;
    virtual bool EssRMgrGetPolicyPriorityTie(EssRMgr* rm) = 0;
    virtual bool EssRMgrGetAVState(EssRMgr* rm, int* state) = 0;
    virtual int EssRMgrResourceGetCount(EssRMgr* rm, int type) = 0;
    virtual bool EssRMgrResourceGetOwner(EssRMgr* rm, int type, int id, int* client, int* priority) = 0;
    virtual bool EssRMgrResourceGetCaps(EssRMgr* rm, int type, int id, EssRMgrCaps* caps) = 0;
    virtual bool EssRMgrResourceGetState(EssRMgr* rm, int type, int id, int* state) = 0;
    virtual bool EssRMgrResourceSetState(EssRMgr* rm, int type, int id, int state) = 0;
    virtual bool EssRMgrRequestResource(EssRMgr* rm, int type, EssRMgrRequest* req) = 0;
    virtual void EssRMgrReleaseResource(EssRMgr* rm, int type, int id) = 0;
    virtual bool EssRMgrRequestSetPriority(EssRMgr* rm, int type, int requestId, int priority) = 0;
    virtual bool EssRMgrRequestSetUsage(EssRMgr* rm, int type, int requestId, EssRMgrUsage* usage) = 0;
    virtual void EssRMgrRequestCancel(EssRMgr* rm, int type, int requestId) = 0;
    virtual bool EssRMgrAddToBlackList(EssRMgr* rm, const char* appId) = 0;
    virtual bool EssRMgrRemoveFromBlackList(EssRMgr* rm, const char* appId) = 0;
    virtual void EssRMgrDumpState(EssRMgr* rm) = 0;
};

class EssRMgrApi {
protected:
    static EssRMgrImpl* impl;

public:
    EssRMgrApi();
    EssRMgrApi(const EssRMgrApi &obj) = delete;
    static void setImpl(EssRMgrImpl* newImpl);
    static bool EssRMgrInit();
    static void EssRMgrTerm();
    static EssRMgr* EssRMgrCreate();
    static void EssRMgrDestroy(EssRMgr* rm);
    static bool EssRMgrGetPolicyPriorityTie(EssRMgr* rm);
    static bool EssRMgrGetAVState(EssRMgr* rm, int* state);
    static int EssRMgrResourceGetCount(EssRMgr* rm, int type);
    static bool EssRMgrResourceGetOwner(EssRMgr* rm, int type, int id, int* client, int* priority);
    static bool EssRMgrResourceGetCaps(EssRMgr* rm, int type, int id, EssRMgrCaps* caps);
    static bool EssRMgrResourceGetState(EssRMgr* rm, int type, int id, int* state);
    static bool EssRMgrResourceSetState(EssRMgr* rm, int type, int id, int state);
    static bool EssRMgrRequestResource(EssRMgr* rm, int type, EssRMgrRequest* req);
    static void EssRMgrReleaseResource(EssRMgr* rm, int type, int id);
    static bool EssRMgrRequestSetPriority(EssRMgr* rm, int type, int requestId, int priority);
    static bool EssRMgrRequestSetUsage(EssRMgr* rm, int type, int requestId, EssRMgrUsage* usage);
    static void EssRMgrRequestCancel(EssRMgr* rm, int type, int requestId);
    static bool EssRMgrAddToBlackList(EssRMgr* rm, const char* appId);
    static bool EssRMgrRemoveFromBlackList(EssRMgr* rm, const char* appId);
    static void EssRMgrDumpState(EssRMgr* rm);
};

extern bool (*EssRMgrInit)();
extern void (*EssRMgrTerm)();
extern EssRMgr* (*EssRMgrCreate)();
extern void (*EssRMgrDestroy)(EssRMgr* rm);
extern bool (*EssRMgrGetPolicyPriorityTie)(EssRMgr* rm);
extern bool (*EssRMgrGetAVState)(EssRMgr* rm, int* state);
extern int (*EssRMgrResourceGetCount)(EssRMgr* rm, int type);
extern bool (*EssRMgrResourceGetOwner)(EssRMgr* rm, int type, int id, int* client, int* priority);
extern bool (*EssRMgrResourceGetCaps)(EssRMgr* rm, int type, int id, EssRMgrCaps* caps);
extern bool (*EssRMgrResourceGetState)(EssRMgr* rm, int type, int id, int* state);
extern bool (*EssRMgrResourceSetState)(EssRMgr* rm, int type, int id, int state);
extern bool (*EssRMgrRequestResource)(EssRMgr* rm, int type, EssRMgrRequest* req);
extern void (*EssRMgrReleaseResource)(EssRMgr* rm, int type, int id);
extern bool (*EssRMgrRequestSetPriority)(EssRMgr* rm, int type, int requestId, int priority);
extern bool (*EssRMgrRequestSetUsage)(EssRMgr* rm, int type, int requestId, EssRMgrUsage* usage);
extern void (*EssRMgrRequestCancel)(EssRMgr* rm, int type, int requestId);
extern bool (*EssRMgrAddToBlackList)(EssRMgr* rm, const char* appId);
extern bool (*EssRMgrRemoveFromBlackList)(EssRMgr* rm, const char* appId);
extern void (*EssRMgrDumpState)(EssRMgr* rm);
